...
public class SnapshotFiltersTest {
    ...
    public void applyWithUniversalRequestPattern() {
        SnapshotFilters filters = new SnapshotFilters(RequestPattern.ANYTHING, null);
    ...
    public void applyWithIds() {
        ...
        SnapshotFilters filters = new SnapshotFilters(null, ids);
    ...
    public void applyWithMethodAndUrlPattern() {
        SnapshotFilters filters = new SnapshotFilters(newRequestPattern(GET, urlEqualTo("/foo")).build(), null);
        MockRequest request = mockRequest().method(GET).url("/foo");
    ...
    public void applyWithIdsAndMethodPattern() {
        ...
        SnapshotFilters filters = new SnapshotFilters(
