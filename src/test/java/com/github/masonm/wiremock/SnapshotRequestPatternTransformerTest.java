...
public class SnapshotRequestPatternTransformerTest {
    ...
    public void applyWithDefaultsAndNoBody() {
        ...
        assertEquals(expected.build(), new SnapshotRequestPatternTransformer().apply(request).build());
    }
    ...
    public void applyWithHeaders() {
        ...
        assertEquals(expected.build(), new SnapshotRequestPatternTransformer(headers).apply(request).build());
    }
